function plot_estimators(H,H_mle,H_mm,H_cae,H_jk,H_est,sampleSz,s)
...
figure
ma = max(reshape([H_mle,H_mm,H_cae,H_jk,H_est],[],1));
mi = min(reshape([H_mle,H_mm,H_cae,H_jk,H_est],[],1));
...
errorbar(sampleSz,mean(H_est,2),std(H_est,[],2),'ms-','linewidth',lw,'markersize',ms), hold on
