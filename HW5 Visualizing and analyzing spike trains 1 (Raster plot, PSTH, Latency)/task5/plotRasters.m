function [Train]=plotRasters(spikeTimes, stimOnsets, direction, stimDuration)
% Plot spike rasters.
...
%%  
  ...
  stimulusOnset_sort= stimOnsets(order);
    ...
    for i = 1 : length(stimOnsets)
        ...
        I = ( spikeTimes < (stimOnsets(i)+stimDuration+postStim) & spikeTimes >= (stimOnsets(i)-preStim)) ; 
